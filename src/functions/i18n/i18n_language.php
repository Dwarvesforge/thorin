 ...
 */
function i18n_language($available = null, $default = null, $getParam = 'lang') {
	// default parameters
	if ($available == null) $available = \Thorin::i18n_available_languages();
	if ($default == null) $default = \Thorin::i18n_default_language();
	// get the browser language:
	$browserLanguage = \Thorin::i18n_browser_language();
